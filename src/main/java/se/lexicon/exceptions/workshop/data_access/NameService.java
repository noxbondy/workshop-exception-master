...
public class NameService {
	    ...
	    public void addFemaleFirstName(String name){
	    	...
	    	CSVReader_Writer.saveFemaleNames("firstname_female.txt", femaleFirstNames);
	    ...
	    public void addMaleFirstName(String name){
	        ...
	        CSVReader_Writer.saveMaleNames("firstname.txt", maleFirstNames);
	    }
	    ...
	    public void addLastName(String lastName){
	        ...
	        CSVReader_Writer.saveLastNames("lastnames.txt", lastNames);
	    }
